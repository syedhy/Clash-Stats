...
struct ClashTimelineProvider: TimelineProvider {
    ...
    private func mockWarStatus() -> WarStatus {
        WarStatus(state: "inWar", title: "Battle Day", clanName: "Night Riders", opponentName: "Enemy Clan", teamSize: 15, isSpectator: false, attacksPerMember: 2, attacksUsed: 1, attacksLeft: 1, playerStars: 2, clanStars: 34, opponentStars: 31, clanDestruction: 87.4, opponentDestruction: 82.1, playerDestruction: 75.0, phaseEndsAt: ISO8601DateFormatter().string(from: Date().addingTimeInterval(5*3600)), warStartTime: nil, warEndTime: nil, lastUpdated: nil)
    }
